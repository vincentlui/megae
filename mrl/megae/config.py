...
default_ddpg_config = lambda: AnnotatedAttrDict(
    ...
    go_eexplore=(0., 'epsilon exploration bonus from each point of go explore, when using intrinsic curiosity'),
    ...
    num_envs=(10, 'number of parallel envs to run'),
...
def megae_config():
    ...
    config.actor_weight_decay_expl = 0.
